...
class StandardsTest(IMP.test.TestCase):
    def test_value_objects(self):
        ...
        exceptions= []
        return self.assertValueObjects(IMP.symmetry,exceptions)
    def test_classes(self):
        "Test that module class names follow the standards"
        exceptions=[]
        return self.assertClassNames(IMP.symmetry, exceptions,
                                     spelling_exceptions)
    def test_functions(self):
        "Test that module function names follow the standards"
        exceptions= []
        return self.assertFunctionNames(IMP.symmetry, exceptions,
                                        spelling_exceptions)
    def test_show(self):
        "Test all objects have show"
        exceptions=[]
        return self.assertShow(IMP.symmetry, exceptions)
