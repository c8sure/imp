...
# from tools/build/container_templates/test_state.py
...
class Tests(IMP.test.TestCase):
    ...
    def test_set(self):
        ...
        f = PairTestModifier(k)  # noqa: F821
        print("apply")
        ...
        m.update()
        for p in cs:
            self.assertTrue(particle_pair_has_attribute(p, k))  # noqa: F821
        print("done")
    ...
    def test_sset(self):
        ...
        f = PairTestModifier(k)  # noqa: F821
        print("apply")
        s = self.create_pair_score_state(f, None, m, t)
        m.add_score_state(s)
        print("add")
        m.update()
        self.assertTrue(particle_pair_has_attribute(t, k))  # noqa: F821
        print("done")
