...
class Tests(IMP.test.TestCase):
    ...
    def test_set(self):
        ...
        f = SingletonTestModifier(k)  # noqa: F821
        print("apply")
        ...
        m.update()
        for p in cs:
            self.assertTrue(particle_has_attribute(p, k))  # noqa: F821
        print("done")
    ...
    def test_sset(self):
        ...
        f = SingletonTestModifier(k)  # noqa: F821
        print("apply")
        s = self.create_singleton_score_state(f, None, m, t)
        m.add_score_state(s)
        print("add")
        m.update()
        self.assertTrue(particle_has_attribute(t, k))  # noqa: F821
        print("done")
