...
class Object(_NonCopyable):
    ...
    def get_version_info(self):
        ...
        val = _IMP_kernel.Object_get_version_info(self)
    ...
    def get_type_name(self):
        ...
        val = _IMP_kernel.Object_get_type_name(self)
...
class RestraintSet(Restraint):
    ...
    def __get_restraints(self):  return _list_util.VarList(getdimfunc=self.get_number_of_restraints,  getfunc=self.get_restraint, erasefunc=self.erase_restraint,  appendfunc=self.add_restraint, extendfunc=self.add_restraints,  clearfunc=self.clear_restraints, indexfunc=self._python_index_restraint)  
    def __set_restraints(self, obj): _list_util.set_varlist(self.restraints, obj)  
    def __del_restraints(self): _list_util.del_varlist(self.restraints)       
...
class Model(Object):
    ...
    def __get_score_states(self):  return _list_util.VarList(getdimfunc=self.get_number_of_score_states,  getfunc=self.get_score_state, erasefunc=self.erase_score_state,  appendfunc=self.add_score_state, extendfunc=self.add_score_states,  clearfunc=self.clear_score_states, indexfunc=self._python_index_score_state)  
    def __set_score_states(self, obj): _list_util.set_varlist(self.score_states, obj)  
    def __del_score_states(self): _list_util.del_varlist(self.score_states)       
...
class Optimizer(ModelObject):
    ...
    def __set_optimizer_states(self, obj): _list_util.set_varlist(self.optimizer_states, obj)  
    def __del_optimizer_states(self): _list_util.del_varlist(self.optimizer_states)       
