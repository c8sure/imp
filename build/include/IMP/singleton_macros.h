...
// from tools/build/container_templates/kernel/classname_macros.h
...
/** Like IMP_SINGLETON_SCORE_METHODS but the Evaluate method can be overridden
 ...
 */
#define IMP_SINGLETON_SCORE_METHODS_UNCHECKED(Name, Setup, Evaluate)           \
  double evaluate_indexes(Model *m, const ParticleIndexes &p,                  \
                          DerivativeAccumulator *da, unsigned int lower_bound, \
                          unsigned int upper_bound,                            \
                          bool all_indexes_checked=false)                      \
