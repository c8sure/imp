...
/*
 * \file IMP/multifit/multifit_config.h
 ...
 * IMPMULTIFITEXPORT if they are intended to be part of the API and
...
#define IMPMULTIFIT_EXPORT_TEMPLATE(name)     \
...
#else  // MSC and SWIG
#define IMPMULTIFIT_EXPORT_TEMPLATE(name) IMP_REQUIRE_SEMICOLON_NAMESPACE
...
#define IMPMULTIFIT_BEGIN_NAMESPACE \
  IMP_COMPILER_ENABLE_WARNINGS namespace IMP{ namespace multifit {

#define IMPMULTIFIT_END_NAMESPACE } } \
IMP_COMPILER_DISABLE_WARNINGS

#define IMPMULTIFIT_BEGIN_INTERNAL_NAMESPACE IMPMULTIFIT_BEGIN_NAMESPACE \
  namespace internal {

#define IMPMULTIFIT_END_INTERNAL_NAMESPACE } IMPMULTIFIT_END_NAMESPACE

#else  // SWIG and DOXYGEN
#define IMPMULTIFIT_BEGIN_NAMESPACE namespace IMP{ namespace multifit {
...
#define IMP_MULTIFIT_USE_IMP_CGAL
#define IMP_MULTIFIT_HAS_IMP_CGAL 1
#define IMP_MULTIFIT_USE_IMP_CONTAINER
#define IMP_MULTIFIT_HAS_IMP_CONTAINER 1
#define IMP_MULTIFIT_USE_IMP_DISPLAY
#define IMP_MULTIFIT_HAS_IMP_DISPLAY 1
#define IMP_MULTIFIT_USE_IMP_ISD
#define IMP_MULTIFIT_HAS_IMP_ISD 1
#define IMP_MULTIFIT_USE_IMP_KERNEL
#define IMP_MULTIFIT_HAS_IMP_KERNEL 1
#define IMP_MULTIFIT_USE_IMP_RMF
#define IMP_MULTIFIT_HAS_IMP_RMF 1
#define IMP_MULTIFIT_USE_IMP_SAXS
#define IMP_MULTIFIT_HAS_IMP_SAXS 1
#define IMP_MULTIFIT_USE_IMP_SCORE_FUNCTOR
#define IMP_MULTIFIT_HAS_IMP_SCORE_FUNCTOR 1
#define IMP_MULTIFIT_USE_BOOST_GRAPH
#define IMP_MULTIFIT_HAS_BOOST_GRAPH 1
#define IMP_MULTIFIT_USE_BOOST_RANDOM
#define IMP_MULTIFIT_HAS_BOOST_RANDOM 1
#define IMP_MULTIFIT_USE_BOOST_REGEX
#define IMP_MULTIFIT_HAS_BOOST_REGEX 1
#define IMP_MULTIFIT_USE_BOOST_SYSTEM
#define IMP_MULTIFIT_HAS_BOOST_SYSTEM 1
#define IMP_MULTIFIT_USE_CGAL
#define IMP_MULTIFIT_HAS_CGAL 1
#define IMP_MULTIFIT_USE_HDF5
#define IMP_MULTIFIT_HAS_HDF5 1
#define IMP_MULTIFIT_USE_NUMPY
#define IMP_MULTIFIT_HAS_NUMPY 1
#define IMP_MULTIFIT_USE_RMF
#define IMP_MULTIFIT_HAS_RMF 1
#define IMP_MULTIFIT_USE_PYTHON_IHM
#define IMP_MULTIFIT_HAS_PYTHON_IHM 1

// functions are defined explicitly for SWIG
namespace IMP{ namespace multifit {
/** \name Standard module functions
  ...
  */
    ...
    IMPMULTIFITEXPORT std::string get_module_version();
#endif

#if !defined(SWIG) || defined(IMP_SWIG_WRAPPER)
    // SWIG will whine about duplicate definitions of function
    inline std::string get_module_name() { return "IMP::multifit"; }
#endif
    ...
    */
#if !defined(SWIG)
    IMPMULTIFITEXPORT std::string get_data_path(std::string file_name);
#endif
    ...
    */
#if !defined(SWIG)
    IMPMULTIFITEXPORT std::string get_example_path(std::string file_name);
#endif
    /** @} */
...
namespace IMP{ namespace multifit { namespace internal {
using ::IMP::Showable;
using ::IMP::operator<<;
using ::IMP::hash_value;
} } } // namespace
...
#ifdef IMPMULTIFIT_DEPRECATED_HEADER
#undef IMPMULTIFIT_DEPRECATED_HEADER
#undef IMPMULTIFIT_DEPRECATED_VALUE_DEF
#undef IMPMULTIFIT_DEPRECATED_VALUE_DECL
#undef IMPMULTIFIT_DEPRECATED_OBJECT_DEF
#undef IMPMULTIFIT_DEPRECATED_OBJECT_DECL
#undef IMPMULTIFIT_DEPRECATED_FUNCTION_DEF
#undef IMPMULTIFIT_DEPRECATED_FUNCTION_DECL
#undef IMPMULTIFIT_DEPRECATED_METHOD_DEF
#undef IMPMULTIFIT_DEPRECATED_METHOD_DECL
#undef IMPMULTIFIT_DEPRECATED_MACRO
#undef IMPMULTIFIT_SHOW_WARNINGS
#endif

// the central modules we can update easily, so don't warn in them
#if defined( IMPMULTIFIT_COMPILATION)                                 \
  || defined(SWIG) || defined(IMP_SWIG_WRAPPER)                         \
  || defined( IMPMULTIFIT_ALL) || defined(IMP_DOXYGEN)                \
...
#define IMPMULTIFIT_SHOW_WARNINGS 0
#else
#define IMPMULTIFIT_SHOW_WARNINGS 1
#endif

// suppress header warnings with all header, SWIG wrapper and in the module
#if IMPMULTIFIT_SHOW_WARNINGS
#define IMPMULTIFIT_DEPRECATED_HEADER(version, help_message)          \
    IMP_PRAGMA(message(__FILE__ " is deprecated: " help_message))
#define IMPMULTIFIT_DEPRECATED_VALUE_DECL(version)    \
  IMP_DEPRECATED_ATTRIBUTE
#define IMPMULTIFIT_DEPRECATED_OBJECT_DECL(version)    \
  IMP_DEPRECATED_ATTRIBUTE
#define IMPMULTIFIT_DEPRECATED_FUNCTION_DECL(version) \
  IMP_DEPRECATED_ATTRIBUTE
#define IMPMULTIFIT_DEPRECATED_METHOD_DECL(version) \
  IMP_DEPRECATED_ATTRIBUTE

#else //IMPMULTIFIT_SHOW_WARNINGS
...
#endif // IMPMULTIFIT_SHOW_WARNINGS
...
/** See [deprecation support](@ref deprecation). */
#define IMPMULTIFIT_DEPRECATED_MACRO(version, message)
...
/** See [deprecation support](@ref deprecation). */
#define IMPMULTIFIT_DEPRECATED_VALUE_DEF(version, message) \
  IMP_DEPRECATED_VALUE_RUNTIME_WARNING(version, message)

/** See [deprecation support](@ref deprecation). */
#define IMPMULTIFIT_DEPRECATED_OBJECT_DEF(version, message) \
  IMP_DEPRECATED_OBJECT_RUNTIME_WARNING(version, message)

/** See [deprecation support](@ref deprecation). */
#define IMPMULTIFIT_DEPRECATED_FUNCTION_DEF(version, message) \
  IMP_DEPRECATED_FUNCTION_RUNTIME_WARNING(version, message)

/** See [deprecation support](@ref deprecation). */
#define IMPMULTIFIT_DEPRECATED_METHOD_DEF(version, message) \
