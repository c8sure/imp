...
#define IMPATOM_EXPORT_TEMPLATE(name)     \
...
#define IMPATOM_BEGIN_NAMESPACE \
  IMP_COMPILER_ENABLE_WARNINGS namespace IMP{ namespace atom {

#define IMPATOM_END_NAMESPACE } } \
IMP_COMPILER_DISABLE_WARNINGS

#define IMPATOM_BEGIN_INTERNAL_NAMESPACE IMPATOM_BEGIN_NAMESPACE \
  namespace internal {

#define IMPATOM_END_INTERNAL_NAMESPACE } IMPATOM_END_NAMESPACE

#else  // SWIG and DOXYGEN
#define IMPATOM_BEGIN_NAMESPACE namespace IMP{ namespace atom {
...
#define IMP_ATOM_USE_HDF5
#define IMP_ATOM_HAS_HDF5 1
#define IMP_ATOM_USE_NUMPY
#define IMP_ATOM_HAS_NUMPY 1
#define IMP_ATOM_USE_PYTHON_IHM
#define IMP_ATOM_HAS_PYTHON_IHM 1
...
/** \name Standard module functions
  ...
  */
    ...
    inline std::string get_module_name() { return "IMP::atom"; }
#endif
...
#ifdef IMPATOM_DEPRECATED_HEADER
#undef IMPATOM_DEPRECATED_HEADER
#undef IMPATOM_DEPRECATED_VALUE_DEF
#undef IMPATOM_DEPRECATED_VALUE_DECL
#undef IMPATOM_DEPRECATED_OBJECT_DEF
#undef IMPATOM_DEPRECATED_OBJECT_DECL
#undef IMPATOM_DEPRECATED_FUNCTION_DEF
#undef IMPATOM_DEPRECATED_FUNCTION_DECL
#undef IMPATOM_DEPRECATED_METHOD_DEF
#undef IMPATOM_DEPRECATED_METHOD_DECL
#undef IMPATOM_DEPRECATED_MACRO
#undef IMPATOM_SHOW_WARNINGS
#endif

// the central modules we can update easily, so don't warn in them
#if defined( IMPATOM_COMPILATION)                                 \
  || defined(SWIG) || defined(IMP_SWIG_WRAPPER)                         \
  || defined( IMPATOM_ALL) || defined(IMP_DOXYGEN)                \
...
#define IMPATOM_SHOW_WARNINGS 0
#else
#define IMPATOM_SHOW_WARNINGS 1
#endif

// suppress header warnings with all header, SWIG wrapper and in the module
#if IMPATOM_SHOW_WARNINGS
#define IMPATOM_DEPRECATED_HEADER(version, help_message)          \
    IMP_PRAGMA(message(__FILE__ " is deprecated: " help_message))
#define IMPATOM_DEPRECATED_VALUE_DECL(version)    \
  IMP_DEPRECATED_ATTRIBUTE
#define IMPATOM_DEPRECATED_OBJECT_DECL(version)    \
  IMP_DEPRECATED_ATTRIBUTE
#define IMPATOM_DEPRECATED_FUNCTION_DECL(version) \
  IMP_DEPRECATED_ATTRIBUTE
#define IMPATOM_DEPRECATED_METHOD_DECL(version) \
  IMP_DEPRECATED_ATTRIBUTE

#else //IMPATOM_SHOW_WARNINGS
...
/** See [deprecation support](@ref deprecation). */
#define IMPATOM_DEPRECATED_MACRO(version, message)
...
/** See [deprecation support](@ref deprecation). */
#define IMPATOM_DEPRECATED_VALUE_DEF(version, message) \
  IMP_DEPRECATED_VALUE_RUNTIME_WARNING(version, message)

/** See [deprecation support](@ref deprecation). */
#define IMPATOM_DEPRECATED_OBJECT_DEF(version, message) \
  IMP_DEPRECATED_OBJECT_RUNTIME_WARNING(version, message)

/** See [deprecation support](@ref deprecation). */
#define IMPATOM_DEPRECATED_FUNCTION_DEF(version, message) \
  IMP_DEPRECATED_FUNCTION_RUNTIME_WARNING(version, message)

/** See [deprecation support](@ref deprecation). */
#define IMPATOM_DEPRECATED_METHOD_DEF(version, message) \
