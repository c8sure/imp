...
/** Stores a shared collection of Triplets.
 */
class IMPKERNELEXPORT TripletContainer : public Container {
 public:
  ...
  void apply_generic_moved(const TripletModifier *m,
  ...
  //! Apply a TripletModifier to the contents
  void apply_moved(const TripletModifier *sm,
                   const ParticleIndexes &moved_pis,
                   const ParticleIndexes &reset_pis) const;
 ...
 protected:
  ...
  virtual void do_apply_moved(const TripletModifier *sm,
                              const ParticleIndexes &moved_pis,
                              const ParticleIndexes &reset_pis) const {
  ...
  virtual void get_indexes_in_place(ParticleIndexTriplets& output) const{
    output= get_indexes();
  }
#endif
 ...
 private:
  ...
  mutable ParticleIndexTriplets contents_cache_;
...
/** This class allows either a list or a container to be
    accepted as input.
*/
class IMPKERNELEXPORT TripletContainerAdaptor :
#if !defined(SWIG) && !defined(IMP_DOXYGEN)
    public Pointer<TripletContainer>
#else
    public InputAdaptor
#endif
    {
  typedef Pointer<TripletContainer> P;
 ...
 public:
  ...
  /**
     ...
     @param t a non-empty list of ParticleTripletsTemp
  */
