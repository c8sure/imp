...
class IMPCOREEXPORT ConstantSingletonPredicate : public SingletonPredicate {
  ...
  template<class Archive> void serialize(Archive &ar) {
    ar(cereal::base_class<SingletonPredicate>(this), v_);
  }
  IMP_OBJECT_SERIALIZE_DECL(ConstantSingletonPredicate);
...
class IMPCOREEXPORT UnorderedTypeSingletonPredicate
  ...
  friend class cereal::access;
  template<class Archive> void serialize(Archive &ar) {
    ar(cereal::base_class<SingletonPredicate>(this));
  }
  IMP_OBJECT_SERIALIZE_DECL(UnorderedTypeSingletonPredicate);
...
class IMPCOREEXPORT OrderedTypeSingletonPredicate : public SingletonPredicate {
 ...
 public:
  ...
  virtual int get_value_index_in_batch(Model* m, ParticleIndex pi) const
  override{
    IMP_UNUSED(m);
...
class IMPCOREEXPORT AllSameSingletonPredicate : public SingletonPredicate {
  ...
  IMP_OBJECT_SERIALIZE_DECL(AllSameSingletonPredicate);
