...
class IMPKERNELEXPORT PairContainer : public Container {
 public:
  ...
  void apply_generic_moved(const PairModifier *m,
  ...
  //! Apply a PairModifier to the contents
  void apply_moved(const PairModifier *sm,
                   const ParticleIndexes &moved_pis,
                   const ParticleIndexes &reset_pis) const;
 ...
 protected:
  ...
  virtual void do_apply_moved(const PairModifier *sm,
                              const ParticleIndexes &moved_pis,
                              const ParticleIndexes &reset_pis) const {
  ...
  virtual void get_indexes_in_place(ParticleIndexPairs& output) const{
    output= get_indexes();
  }
#endif
