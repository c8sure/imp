...
/** TripletScore will evaluate the score and derivatives
    for passed object(s) of type ParticleIndexTriplet.

    Use in conjunction with various
    restraints such as IMP::container::TripletsRestraint or
    IMP::core::TripletRestraint. The restraints couple the score
    functions with appropriate lists of object(s) of type ParticleIndexTriplet.
    ...
    \see PredicateTripletRestraint
*/
class IMPKERNELEXPORT TripletScore : public ParticleInputs,
                                       public Object {
 public:
  ...
  /** @param m the model of vt
      @param vt the index in m of an object of type ParticleTriplet
  ...
  /** @param m the model of o
      @param o objects of type ParticleTriplet, specified by index
      ...
      @note An implementation for this is provided by
            the IMP_TRIPLET_SCORE_METHODS() macro.
  */
  virtual double evaluate_indexes(Model *m, const ParticleIndexTriplets &o,
  ...
  */
  virtual double evaluate_if_good_index(Model *m, const ParticleIndexTriplet& vt,
                                        DerivativeAccumulator *da,
                                        double max) const;
  ...
  */
  ...
  //! Decompose this TripletScore into a set of
