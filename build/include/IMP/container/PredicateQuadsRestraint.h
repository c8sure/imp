...
*/
class IMPCONTAINEREXPORT PredicateQuadsRestraint : public Restraint {
  PointerMember<QuadPredicate> predicate_;
  PointerMember<QuadContainer> input_;
#if IMP_CONTAINER_HAS_ROBIN_MAP==1
  typedef tsl::robin_map<int, ParticleIndexQuads> t_lists_map;
  typedef tsl::robin_map<int, PointerMember<QuadScore> > t_score_map;
#elif IMP_CONTAINER_HAS_GOOGLE_DENSE_HASH_MAP==1
  typedef google::dense_hash_map<int, ParticleIndexQuads> t_lists_map;
  typedef google::dense_hash_map<int, PointerMember<QuadScore> > t_score_map;
#else
  typedef IMP_KERNEL_LARGE_UNORDERED_MAP<int, ParticleIndexQuads> t_lists_map;
  typedef IMP_KERNEL_LARGE_UNORDERED_MAP<int, PointerMember<QuadScore> > t_score_map;
#endif
  ...
  PointerMember<QuadScore> unknown_score_;
  ...
  IMP_OBJECT_SERIALIZE_DECL(PredicateQuadsRestraint);

  //  void update_lists_with_item(ParticleIndexQuad const &it) const;
...
#ifndef SWIG
QuadScore*
PredicateQuadsRestraint::get_score_for_predicate
(int predicate) const
{
  QuadScore* score;
