...
*/
class IMPCONTAINEREXPORT PredicatePairsRestraint : public Restraint {
  PointerMember<PairPredicate> predicate_;
  PointerMember<PairContainer> input_;
#if IMP_CONTAINER_HAS_ROBIN_MAP==1
  typedef tsl::robin_map<int, ParticleIndexPairs> t_lists_map;
  typedef tsl::robin_map<int, PointerMember<PairScore> > t_score_map;
#elif IMP_CONTAINER_HAS_GOOGLE_DENSE_HASH_MAP==1
  typedef google::dense_hash_map<int, ParticleIndexPairs> t_lists_map;
  typedef google::dense_hash_map<int, PointerMember<PairScore> > t_score_map;
#else
  typedef IMP_KERNEL_LARGE_UNORDERED_MAP<int, ParticleIndexPairs> t_lists_map;
  typedef IMP_KERNEL_LARGE_UNORDERED_MAP<int, PointerMember<PairScore> > t_score_map;
#endif
  ...
  PointerMember<PairScore> unknown_score_;
  ...
  IMP_OBJECT_SERIALIZE_DECL(PredicatePairsRestraint);

  //  void update_lists_with_item(ParticleIndexPair const &it) const;
...
#ifndef SWIG
PairScore*
PredicatePairsRestraint::get_score_for_predicate
(int predicate) const
{
  PairScore* score;
