...
class IMPCONTAINEREXPORT DynamicListSingletonContainer :
...
#else
    public IMP::internal::DynamicListContainer<SingletonContainer>
#endif
    {
  typedef IMP::internal::DynamicListContainer<SingletonContainer> P;
  ...
  */
  DynamicListSingletonContainer(Container *scope, std::string name =
...
#endif
  IMP_OBJECT_METHODS(DynamicListSingletonContainer);
};
