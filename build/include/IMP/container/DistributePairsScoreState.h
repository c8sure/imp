...
*/
class IMPCONTAINEREXPORT DistributePairsScoreState : public ScoreState {
  PointerMember<PairContainer> input_;
  typedef boost::tuple<Pointer<DynamicListPairContainer>,
                       PointerMember<PairPredicate>, int> Data;
  Vector<Data> data_;
 ...
 public:
  ...
  DynamicListPairContainer *add_predicate(PairPredicate *predicate,
                                               int value) {
    IMP_NEW(DynamicListPairContainer, c,
  ...
  IMP_OBJECT_METHODS(DistributePairsScoreState);
};
