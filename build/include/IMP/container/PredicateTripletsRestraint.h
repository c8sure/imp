...
class IMPCONTAINEREXPORT PredicateTripletsRestraint : public Restraint {
...
#if IMP_CONTAINER_HAS_ROBIN_MAP==1
  typedef tsl::robin_map<int, ParticleIndexTriplets> t_lists_map;
  typedef tsl::robin_map<int, PointerMember<TripletScore> > t_score_map;
#elif IMP_CONTAINER_HAS_GOOGLE_DENSE_HASH_MAP==1
  typedef google::dense_hash_map<int, ParticleIndexTriplets> t_lists_map;
  typedef google::dense_hash_map<int, PointerMember<TripletScore> > t_score_map;
#else
  typedef IMP_KERNEL_LARGE_UNORDERED_MAP<int, ParticleIndexTriplets> t_lists_map;
  typedef IMP_KERNEL_LARGE_UNORDERED_MAP<int, PointerMember<TripletScore> > t_score_map;
#endif
  ...
  PointerMember<TripletScore> unknown_score_;
  ...
  IMP_OBJECT_SERIALIZE_DECL(PredicateTripletsRestraint);

  //  void update_lists_with_item(ParticleIndexTriplet const &it) const;
...
#ifndef SWIG
TripletScore*
PredicateTripletsRestraint::get_score_for_predicate
(int predicate) const
{
  TripletScore* score;
