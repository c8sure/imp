 ...
 */
class IMPCONTAINEREXPORT MinimumPairRestraint : public Restraint {
 ...
 public:
   ...
   */
  MinimumPairRestraint(PairScore *f, PairContainerAdaptor c,
                            unsigned int n = 1,
                            std::string name = "MinimumPairRestraint %1%");
