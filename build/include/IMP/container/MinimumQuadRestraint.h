 ...
 */
class IMPCONTAINEREXPORT MinimumQuadRestraint : public Restraint {
  IMP::PointerMember<QuadScore> f_;
 ...
 public:
   ...
   */
  MinimumQuadRestraint(QuadScore *f, QuadContainerAdaptor c,
                            unsigned int n = 1,
                            std::string name = "MinimumQuadRestraint %1%");

 public:
  double unprotected_evaluate(IMP::DerivativeAccumulator *accum) const
      override;
  IMP::ModelObjectsTemp do_get_inputs() const override;
  IMP_OBJECT_METHODS(MinimumQuadRestraint);
  ;
