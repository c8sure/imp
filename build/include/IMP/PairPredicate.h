...
*/
class IMPKERNELEXPORT PairPredicate : public ParticleInputs,
                                           public Object {
 public:
  ...
  virtual void remove_if_equal(Model *m, ParticleIndexPairs &ps,
                               int v) const;
  //! remove any particles in ps for which this predicate does not evaluate to v
  virtual void remove_if_not_equal(Model *m, ParticleIndexPairs &ps,
                                   int v) const;
#endif
