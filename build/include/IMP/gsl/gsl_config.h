 ...
 * IMPGSLEXPORT if they are intended to be part of the API and
 ...
 *
 * All code in this module should live in the IMP::gsl namespace.
 * This is simply achieved by wrapping things with the
 * IMPGSL_BEGIN_NAMESPACE and IMPGSL_END_NAMESPACE macros.
...
#ifndef IMPGSL_CONFIG_H
#define IMPGSL_CONFIG_H
...
#ifdef IMPGSL_EXPORTS
#define IMPGSLEXPORT __declspec(dllexport)
#else  // EXPORTS
#define IMPGSLEXPORT __declspec(dllimport)
#endif  // EXPORTS

#else  // _MSC_VER

#ifdef GCC_VISIBILITY
#define IMPGSLEXPORT __attribute__((visibility("default")))
#else  // GCC_VISIBILITY
#define IMPGSLEXPORT
...
#define IMPGSL_EXPORT_TEMPLATE(name)     \
...
#else  // MSC and SWIG
#define IMPGSL_EXPORT_TEMPLATE(name) IMP_REQUIRE_SEMICOLON_NAMESPACE

#endif  // MSC and SWIG

#if !defined(SWIG) && !defined(IMP_DOXYGEN)

#define IMPGSL_BEGIN_NAMESPACE \
  IMP_COMPILER_ENABLE_WARNINGS namespace IMP{ namespace gsl {

#define IMPGSL_END_NAMESPACE } } \
IMP_COMPILER_DISABLE_WARNINGS

#define IMPGSL_BEGIN_INTERNAL_NAMESPACE IMPGSL_BEGIN_NAMESPACE \
  namespace internal {

#define IMPGSL_END_INTERNAL_NAMESPACE } IMPGSL_END_NAMESPACE

#else  // SWIG and DOXYGEN
#define IMPGSL_BEGIN_NAMESPACE namespace IMP{ namespace gsl {
...
#define IMP_GSL_USE_IMP_CGAL
#define IMP_GSL_HAS_IMP_CGAL 1
#define IMP_GSL_USE_BOOST_FILESYSTEM
#define IMP_GSL_HAS_BOOST_FILESYSTEM 1
#define IMP_GSL_USE_BOOST_PROGRAMOPTIONS
#define IMP_GSL_HAS_BOOST_PROGRAMOPTIONS 1
#define IMP_GSL_USE_BOOST_RANDOM
#define IMP_GSL_HAS_BOOST_RANDOM 1
#define IMP_GSL_USE_BOOST_SYSTEM
#define IMP_GSL_HAS_BOOST_SYSTEM 1
#define IMP_GSL_USE_CGAL
#define IMP_GSL_HAS_CGAL 1
#define IMP_GSL_USE_NUMPY
#define IMP_GSL_HAS_NUMPY 1

// functions are defined explicitly for SWIG
namespace IMP{ namespace gsl {
/** \name Standard module functions
  ...
  */
    ...
    IMPGSLEXPORT std::string get_module_version();
#endif

#if !defined(SWIG) || defined(IMP_SWIG_WRAPPER)
    // SWIG will whine about duplicate definitions of function
    inline std::string get_module_name() { return "IMP::gsl"; }
#endif
    ...
    */
#if !defined(SWIG)
    IMPGSLEXPORT std::string get_data_path(std::string file_name);
#endif
    ...
    */
#if !defined(SWIG)
    IMPGSLEXPORT std::string get_example_path(std::string file_name);
#endif
    /** @} */
...
namespace IMP{ namespace gsl { namespace internal {
using ::IMP::Showable;
using ::IMP::operator<<;
using ::IMP::hash_value;
} } } // namespace
...
#endif /* IMPGSL_CONFIG_H */

// Here so it is always parsed

#ifdef IMPGSL_DEPRECATED_HEADER
#undef IMPGSL_DEPRECATED_HEADER
#undef IMPGSL_DEPRECATED_VALUE_DEF
#undef IMPGSL_DEPRECATED_VALUE_DECL
#undef IMPGSL_DEPRECATED_OBJECT_DEF
#undef IMPGSL_DEPRECATED_OBJECT_DECL
#undef IMPGSL_DEPRECATED_FUNCTION_DEF
#undef IMPGSL_DEPRECATED_FUNCTION_DECL
#undef IMPGSL_DEPRECATED_METHOD_DEF
#undef IMPGSL_DEPRECATED_METHOD_DECL
#undef IMPGSL_DEPRECATED_MACRO
#undef IMPGSL_SHOW_WARNINGS
#endif

// the central modules we can update easily, so don't warn in them
#if defined( IMPGSL_COMPILATION)                                 \
  || defined(SWIG) || defined(IMP_SWIG_WRAPPER)                         \
  || defined( IMPGSL_ALL) || defined(IMP_DOXYGEN)                \
...
#define IMPGSL_SHOW_WARNINGS 0
#else
#define IMPGSL_SHOW_WARNINGS 1
#endif

// suppress header warnings with all header, SWIG wrapper and in the module
#if IMPGSL_SHOW_WARNINGS
#define IMPGSL_DEPRECATED_HEADER(version, help_message)          \
    IMP_PRAGMA(message(__FILE__ " is deprecated: " help_message))
#define IMPGSL_DEPRECATED_VALUE_DECL(version)    \
  IMP_DEPRECATED_ATTRIBUTE
#define IMPGSL_DEPRECATED_OBJECT_DECL(version)    \
  IMP_DEPRECATED_ATTRIBUTE
#define IMPGSL_DEPRECATED_FUNCTION_DECL(version) \
  IMP_DEPRECATED_ATTRIBUTE
#define IMPGSL_DEPRECATED_METHOD_DECL(version) \
  IMP_DEPRECATED_ATTRIBUTE

#else //IMPGSL_SHOW_WARNINGS
...
/** See [deprecation support](@ref deprecation). */
#define IMPGSL_DEPRECATED_MACRO(version, message)
...
/** See [deprecation support](@ref deprecation). */
#define IMPGSL_DEPRECATED_VALUE_DEF(version, message) \
  IMP_DEPRECATED_VALUE_RUNTIME_WARNING(version, message)

/** See [deprecation support](@ref deprecation). */
#define IMPGSL_DEPRECATED_OBJECT_DEF(version, message) \
  IMP_DEPRECATED_OBJECT_RUNTIME_WARNING(version, message)

/** See [deprecation support](@ref deprecation). */
#define IMPGSL_DEPRECATED_FUNCTION_DEF(version, message) \
  IMP_DEPRECATED_FUNCTION_RUNTIME_WARNING(version, message)

/** See [deprecation support](@ref deprecation). */
#define IMPGSL_DEPRECATED_METHOD_DEF(version, message) \
